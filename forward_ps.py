...
m_forward   = [ 2.7806, -10.7590, 1.8558, 42.0962, 7.1841, 237.3543, 57.6174, 0.0664, 0.1927]
# -------------------------------------------------------------------------------
...
def inversion():
    ...
    insar_files = [
        ...
        '/raid/class239/bferrante/ASC56/FRAME_1/F_merge/20240207_20251023/unwrap_ll_flat_cut_A.grd',
        '/raid/class239/bferrante/DES136/FRAME_1/F_merge/20240225_20250911/unwrap_ll_flat_cut_D.grd',
    ]
    smooth_files = [
        # 'new_data/A100/smooth.grd',
        # 'new_data/D5/smooth.grd',
        '/raid/class239/bferrante/ASC56/FRAME_1/F_merge/20240207_20251023/unwrap_ll_filt_cut.grd',
        '/raid/class239/bferrante/DES136/FRAME_1/F_merge/20240225_20250911/unwrap_ll_filt_cut.grd',

    ]
    look_dirs = [
        # 'new_data/A100/look',
        # 'new_data/D5/look',
        '/raid/class239/bferrante/ASC56/FRAME_1/F_merge',
        '/raid/class239/bferrante/DES136/FRAME_1/F_merge',
    ...
    if forward == 1:
        ...
        cbar = fig.colorbar(sc, ax=axes, label='LOS Displacement (m)', shrink=0.5)
    ...
    if mis == 1:
        ...
        cbar = fig.colorbar(sc, ax=axes, label='LOS Misfit (m)', shrink=0.75)
        cbar.ax.tick_params(labelsize=20)
        plt.tick_params(axis='both', which='major', labelsize=20)
        plt.xlim(-50, 50)
        plt.ylim(-35, 45)
    ...
    if forward_full == 1:
        ...
        cbar = fig.colorbar(sc, ax=axes, label='LOS Displacement (m)', shrink=0.75)
        cbar.ax.tick_params(labelsize=20)
        plt.tick_params(axis='both', which='major', labelsize=20)
        plt.xlim(-50, 50)
        plt.ylim(-35, 45)
